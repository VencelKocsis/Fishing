    ...
    get() {
        ...
        _Fish = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(16f, 17.93f)
                arcToRelative(9.77f, 9.77f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, -11.86f)
            }
            path(
                fill = null,
                fillAlpha = 1.0f,
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.98f, 1.67f)
            ...
            path(
                ...
                lineToRelative(-0.23f, 1.4f)
                arcTo(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = true, 13.8f, 21f)
                horizontalLineTo(9.5f)
                arcToRelative(5.96f, 5.96f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.49f, -3.98f)
            }
        }.build()
        return _Fish!!
    }
